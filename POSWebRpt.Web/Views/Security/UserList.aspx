<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="POSWebRpt.Web.Views.Security.UserList" MasterPageFile="~/Site.Master" Title=":: POS :: User Master" %>
    ...
    <div style="width:850px;margin:0 auto;margin-top:30px;">        
        <fieldset style="width:100%;">
            ...
            <table>
                <tr>
                    <td>
                        <asp:TextBox ID="txtUserName" runat="server" CssClass="watermark" Width="240px" ForeColor="#747862"></asp:TextBox>
                    ...
                    <td>
                        <asp:TextBox ID="txtFName" runat="server" CssClass="watermark" Width="240px" ForeColor="#747862"></asp:TextBox>
                ...
                <asp:UpdatePanel ID="upUser" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderStyle CssClass="gridviewheader" />
                                <ItemStyle CssClass="gridviewitem" Width="17%" HorizontalAlign="Center" VerticalAlign="Middle" />                                    
                                <ItemTemplate>
