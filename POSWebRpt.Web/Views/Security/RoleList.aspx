<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="POSWebRpt.Web.Views.Security.RoleList"  MasterPageFile="~/Site.Master" Title=":: POS :: Manage Role" %>
    ...
    <div style="width:475px;">        
        <fieldset style="width:100%;margin-top:30px;">
            ...
            <table>
                <tr>
                    <td>
                        <asp:TextBox ID="txtRole" runat="server" CssClass="watermark" Width="240px" ForeColor="#747862"></asp:TextBox>
                    ...
                    <td><asp:Button ID="btnSearch" runat="server" Text="Search" ToolTip="Click to search" Width="100px" OnClick="btnSearch_Click" />&nbsp;<asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="button" Width="100px" OnClick="btnReset_Click" /></td>
                </tr>
            </table>              
        </fieldset>
