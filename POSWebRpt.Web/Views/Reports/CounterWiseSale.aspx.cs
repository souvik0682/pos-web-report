...
{
    public partial class CounterWiseSale : System.Web.UI.Page
    {
        ...
        private void GenerateReport()
        {
            ...
            LocalReportManager reportManager = new LocalReportManager(rptViewer, "CounterWiseSale", ConfigurationManager.AppSettings["ReportNamespace"].ToString(), ConfigurationManager.AppSettings["ReportPath"].ToString());
            ReportCriteria criteria = new ReportCriteria();
            BuildCriteria(criteria);
            List<ReportEntity> lstData = ReportBLL.GetCounterWiseSaleSummary(criteria);
