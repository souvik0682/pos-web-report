<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanVsActual.aspx.cs"
    Inherits="REC.Web.Internal.Report.PlanVsActual" MasterPageFile="~/Internal/REC.Master"
    Title=":: RQM :: Inspection Plan Vs Actual Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    <div id="pageheader"><uc1:Navigation ID="ucNav" runat="server" HeaderText="INSPECTION PLAN VS ACTIAL" ShowPrintPanel="true" OnPrintButtonClick="ucNav_PrintButtonClick" /></div>
