<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyQuestionsList.aspx.cs" Title=":: RQM :: Safety Question Master" MasterPageFile="~/Internal/REC.Master" Inherits="REC.Web.Internal.Config.SafetyQuestionsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    ...
    <div id="pageheader">
        SAFETY QUESTION MASTER</div>
    <center>
        <div style="width: 550px;">
            <fieldset style="width: 100%;">
                <legend>Safety Question List</legend>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="~/Images/add.png" Height="16"
                                    ToolTip="Click to add new Question" OnClick="lnkAdd_Click" />
                                <asp:LinkButton ID="lnkAdd" runat="server" ToolTip="Click to add new Question" OnClick="lnkAdd_Click">Add New Question</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </div>
