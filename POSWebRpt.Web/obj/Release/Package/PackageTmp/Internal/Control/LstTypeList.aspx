<%@ Page Title=":: RQM :: List Type Master" Language="C#" MasterPageFile="~/Internal/REC.Master" AutoEventWireup="true" CodeBehind="LstTypeList.aspx.cs" Inherits="REC.Web.Internal.Control.LstTypeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    ...
    <div id="pageheader">LIST TYPE MASTER</div>
    <center>
        <div style="width:550px;">  
            <fieldset style="width: 100%;">
                <legend>Search List Type</legend>
                <table border="0" cellpadding="0" cellspacing="0" class="searchpanel">
                    <tr>
                        <td class="label" style="padding-right:5px;">Type Name:</td>
                        <td style="padding-right:5px;"><asp:TextBox ID="txtType" runat="server" MaxLength="50" Width="200"></asp:TextBox></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="~/Images/add.png" Height="16" ToolTip="Click to add new type" OnClick="lnkAdd_Click" />
                                <asp:LinkButton ID="lnkAdd" runat="server" ToolTip="Click to add new type" OnClick="lnkAdd_Click">Add New Type</asp:LinkButton>    
                            </td>
                        </tr>
                    </table>
                </div>
