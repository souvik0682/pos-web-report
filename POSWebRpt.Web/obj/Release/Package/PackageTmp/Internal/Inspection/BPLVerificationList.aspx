<%@ Page Title=":: RQM :: BPL Verification" Language="C#" MasterPageFile="~/Internal/REC.Master"
    AutoEventWireup="true" CodeBehind="BPLVerificationList.aspx.cs" Inherits="REC.Web.Internal.Inspection.BPLVerificationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    ...
    <div id="pageheader">BPL VERIFICATION</div>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Whether Connection Provided">
                                            <HeaderStyle CssClass="gridviewheader" HorizontalAlign="Left" />
