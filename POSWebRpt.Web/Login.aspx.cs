    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            if (ValidateControl())
            {
                ...
                try
                {
                    bool valid = UserBLL.ValidateUser(user);
                    ...
                    {
                        lblMsg.Text = ResourceManager.GetStringWithoutName("R00003");
                        lblMsg.Visible = true;
                    }
                ...
                catch (System.Data.SqlClient.SqlException ex)
                {
                    ...
                    {
                        case -1:
                            lblMsg.Text = ResourceManager.GetStringWithoutName("R00004");
                            break;
                        case 4060:
                            lblMsg.Text = ResourceManager.GetStringWithoutName("R00005");
                            break;
                        case 18456:
                            lblMsg.Text = ResourceManager.GetStringWithoutName("R00006");
                            break;
                        default:
                            lblMsg.Text = ResourceManager.GetStringWithoutName("R00007");
                            break;
                    }
        ...
        private void SetAttributes()
        {
            ...
            rfvName.ErrorMessage = ResourceManager.GetStringWithoutName("R00001");
            rfvPwd.ErrorMessage = ResourceManager.GetStringWithoutName("R00002");
        }
        ...
        private bool ValidateControl()
        {
            ...
            if (txtUserName.Text.Trim() == string.Empty)
            {
                ...
                lblMsgUsername.Text = ResourceManager.GetStringWithoutName("R00001");
            }
            ...
            if (txtPassword.Text.Trim() == string.Empty)
            {
                ...
                lblMsgPassword.Text = ResourceManager.GetStringWithoutName("R00002");
            }
