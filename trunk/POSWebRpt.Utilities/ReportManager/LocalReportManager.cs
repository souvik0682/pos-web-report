//====================================================================================
// NAME		 : LocalReportManager.cs
// PURPOSE	 : Represents an utility class for generating report using SSRS.
// AUTHORS	 : Amit Kumar Chandra
// COPYRIGHT : Copyright © 2013 CES Technologies Pvt. Ltd.
// COMMENTS	 : 
//====================================================================================
//
// $Log: LocalReportManager.cs,v $
//
//====================================================================================
...
namespace POSWebRpt.Utilities.ReportManager
{
    /// <summary>
