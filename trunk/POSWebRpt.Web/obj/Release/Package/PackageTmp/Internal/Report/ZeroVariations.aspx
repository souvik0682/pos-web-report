<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZeroVariations.aspx.cs" Inherits="REC.Web.Internal.Report.ZeroVariations" Title=":: RQM :: Item Wise Zero Variation Summary" MasterPageFile="~/Internal/REC.Master"%>
...
<div id="pageheader"><uc1:Navigation ID="ucNav" runat="server" HeaderText="ITEM WISE ZERO VARIATION SUMMARY" ShowPrintPanel="true" OnPrintButtonClick="ucNav_PrintButtonClick" /></div>
