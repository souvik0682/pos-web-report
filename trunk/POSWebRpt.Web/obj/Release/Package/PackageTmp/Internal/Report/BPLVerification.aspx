<%@ Page Language="C#" AutoEventWireup="true" Title=":: RQM :: Household Wise BPL Verification" CodeBehind="BPLVerification.aspx.cs" Inherits="REC.Web.Internal.Report.BPLVerification" MasterPageFile="~/Internal/REC.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    <div id="pageheader"><uc1:Navigation ID="ucNav" runat="server" HeaderText="HOUSEHOLD WISE BPL VERIFICATION" ShowPrintPanel="true" OnPrintButtonClick="ucNav_PrintButtonClick" /></div>
    ...
    <center>
        <div style="width: 750px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 10px;">
                            ...
                            <asp:RequiredFieldValidator ID="rfvInspection" runat="server" CssClass="errormessage"
                               ControlToValidate="ddlInspection"  Display="Dynamic" ForeColor=""
                                SetFocusOnError="True"  InitialValue=0  ValidationGroup="Show"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="label" style="padding-right: 5px; padding-top: 10px;">
                        ...
                        <td style="padding-right: 5px; padding-top: 10px;">
                            <asp:Button ID="btnShow" runat="server" Text="Show" ValidationGroup="Show" TabIndex="6" OnClick="btnShow_Click" />
                        </td>
                        <td style="padding-top: 10px;">
                        </td>
                    </tr>
            ...
            <div class="reportpanel" style="width: 100%">
                <rsweb:ReportViewer ID="rptViewer" runat="server" CssClass="rptviewer" ShowExportControls="false" Width="98%">
                </rsweb:ReportViewer>
            </div>
        </div>
    </center>
