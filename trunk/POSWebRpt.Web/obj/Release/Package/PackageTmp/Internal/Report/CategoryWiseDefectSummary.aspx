<%@ Page Title=":: RQM :: Category Wise Defect Summary" Language="C#" MasterPageFile="~/Internal/REC.Master" AutoEventWireup="true" CodeBehind="CategoryWiseDefectSummary.aspx.cs" Inherits="REC.Web.Internal.Report.CategoryWiseDefectSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    <div id="pageheader"><uc1:Navigation ID="ucNav" runat="server" HeaderText="CATEGORY WISE DEFECT SUMMARY" ShowPrintPanel="true" OnPrintButtonClick="ucNav_PrintButtonClick" /></div>
            ...
            <fieldset style="width: 95%;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="searchpanel">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 10px;"><asp:Button ID="btnShow" runat="server" Text="Show" TabIndex="6" OnClick="btnShow_Click" /></td>
                    </tr>
                </table>
            </fieldset>
