<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="POSWebRpt.Web.Views.Security.RoleEdit"
    MasterPageFile="~/Site.Master" Title=":: POS :: Add / Edit Role" %>
        ...
        <fieldset style="width: 600px;">
            ...
            <div>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="width:60px;">
                            Role:<span class="errormessage1">*</span>
                        </td>
                        <td>
                        ...
                        <td colspan="2" style="padding-top:10px;">
                            <cc1:TabContainer ID="tcPP" runat="server" ActiveTabIndex="0">
                                ...
                                <cc1:TabPanel ID="tpImp" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="gvwRpt" runat="server" AutoGenerateColumns="false" AllowPaging="false"
                                            BorderStyle="None" BorderWidth="0" OnRowDataBound="gvwRpt_RowDataBound" Width="100%">
                                            <PagerSettings Mode="NumericFirstLast" Position="TopAndBottom" />
                                            <PagerStyle CssClass="gridviewpager" />
                                            <EmptyDataRowStyle CssClass="gridviewemptydatarow" />
                                            <EmptyDataTemplate>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top:10px;">
                            <asp:Button ID="btnSave" runat="server" Text="Save" ValidationGroup="Save" TabIndex="18"
                                OnClick="btnSave_Click" />&nbsp;&nbsp;<asp:Button ID="btnBack" runat="server" Text="Back" />
                        </td>
                    </tr>
                </table>
            </div>
