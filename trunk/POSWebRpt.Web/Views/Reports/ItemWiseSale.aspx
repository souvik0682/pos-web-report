<%@ Page Title=":: POS :: Item Wise Sale" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemWiseSale.aspx.cs" Inherits="POSWebRpt.Web.Views.Reports.ItemWiseSale" %>
        ...
        <fieldset style="width: 878px;">
            ...
            <div style="padding:10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="padding-right:10px;">Counter:<span class="errormessage">*</span></td>
                        <td style="padding-right:20px;"><asp:DropDownList ID="ddlCounter" runat="server" AutoPostBack="false" Width="250" CssClass="chzn-select medium-select single"><asp:ListItem Value="0" Text="All"></asp:ListItem></asp:DropDownList></td>
                    ...
                    <tr>    
                        ...
                        <td colspan="2"><asp:Button ID="btnShow" runat="server" Text="Show" CssClass="button" ValidationGroup="Show" OnClick="btnShow_Click" /></td>
                    </tr>
                </table>
            </div>
        </fieldset>
