...
{
    public partial class ItemWiseSaleWithCombo : System.Web.UI.Page
    {
        ...
        private void GenerateReport()
        {
            ...
            LocalReportManager reportManager = new LocalReportManager(rptViewer, "ItemWiseSaleWithCombo", ConfigurationManager.AppSettings["ReportNamespace"].ToString(), ConfigurationManager.AppSettings["ReportPath"].ToString());
            ReportCriteria criteria = new ReportCriteria();
            BuildCriteria(criteria);
            List<ReportEntity> lstData = ReportBLL.GetItemWiseSaleWithCombo(criteria);
