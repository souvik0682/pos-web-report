<%@ Page Title=":: POS :: Item Wise Sale With Combo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemWiseSaleWithCombo.aspx.cs" Inherits="POSWebRpt.Web.Views.Reports.ItemWiseSaleWithCombo" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    <div id="pageheader">ITEM WISE SALE WITH COMBO</div>
