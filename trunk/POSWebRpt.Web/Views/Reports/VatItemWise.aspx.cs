...
{
    public partial class VatItemWise : System.Web.UI.Page
    {
        ...
        private void GenerateReport()
        {
            ...
            LocalReportManager reportManager = new LocalReportManager(rptViewer, "VatItemWise", ConfigurationManager.AppSettings["ReportNamespace"].ToString(), ConfigurationManager.AppSettings["ReportPath"].ToString());
