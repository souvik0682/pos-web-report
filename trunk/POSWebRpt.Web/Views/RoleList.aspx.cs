    ...
    public partial class RoleList : System.Web.UI.Page
    {
        ...
        protected void gvwRole_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lnkStatus.OnClientClick = "javascript:return confirm('" + ResourceManager.GetStringWithoutName("R00037") + "');";
        ...
        private void SetAttributes()
        {
            if (!IsPostBack)
            {
                txtWMERole.WatermarkText = ResourceManager.GetStringWithoutName("R00036");
                ...
                btnAdd.ToolTip = ResourceManager.GetStringWithoutName("R00056");
        ...
        private void ChangeRoleStatus(int roleId, bool status)
        {
            ...
            IActionResult result = UserBLL.ChangeRoleStatus(roleId, status, _userId);
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/Views/Security/RoleEdit.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.RoleName = (txtRole.Text == ResourceManager.GetStringWithoutName("R00036")) ? string.Empty : txtRole.Text.Trim();
        ...
        private void RetrieveSearchCriteria()
        {
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                {
                    if (criteria.CurrentPage != PageName.RoleMaster)
                    {
                        criteria.Clear();
        ...
        private void SetDefaultSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.SortExpression = sortExpression;
            criteria.SortDirection = sortDirection;
            criteria.CurrentPage = PageName.RoleMaster;
